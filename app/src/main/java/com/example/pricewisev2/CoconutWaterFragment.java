...
public class CoconutWaterFragment extends Fragment {

    private CoconutWaterViewModel mViewModel;
    private UserViewModel userViewModel;

    public static CoconutWaterFragment newInstance() {
        return new CoconutWaterFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_coconut_water, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(CoconutWaterViewModel.class);
