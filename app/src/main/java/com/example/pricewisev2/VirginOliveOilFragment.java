...
public class VirginOliveOilFragment extends Fragment {

    private VirginOliveOilViewModel mViewModel;
    private UserViewModel userViewModel;

    public static VirginOliveOilFragment newInstance() {
        return new VirginOliveOilFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_virgin_olive_oil, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(VirginOliveOilViewModel.class);
