...
public class NutellaFragment extends Fragment {
    ...
    private NutellaViewModel mViewModel;
    private UserViewModel userViewModel;

    public static NutellaFragment newInstance() {
        return new NutellaFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_nutella, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(NutellaViewModel.class);
