...
public class VanillaIceCream1LFragment extends Fragment {

    private VanillaIceCream1LViewModel mViewModel;
    private UserViewModel userViewModel;

    public static VanillaIceCream1LFragment newInstance() {
        return new VanillaIceCream1LFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_vanilla_ice_cream1_l, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(VanillaIceCream1LViewModel.class);
