...
public class FrozenFriesFragment extends Fragment {

    private FrozenFriesViewModel mViewModel;
    private UserViewModel userViewModel;

    public static FrozenFriesFragment newInstance() {
        return new FrozenFriesFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_frozen_fries, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(FrozenFriesViewModel.class);
