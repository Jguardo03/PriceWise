...
public class VanillaCakeFragment extends Fragment {

    private VanillaCakeViewModel mViewModel;
    private UserViewModel userViewModel;

    public static VanillaCakeFragment newInstance() {
        return new VanillaCakeFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_vanilla_cake, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(VanillaCakeViewModel.class);
