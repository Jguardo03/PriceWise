...
public class FreshBananaFragment extends Fragment {

    private FreshBananaViewModel mViewModel;
    private UserViewModel userViewModel;

    public static FreshBananaFragment newInstance() {
        return new FreshBananaFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_fresh_banana, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(FreshBananaViewModel.class);
