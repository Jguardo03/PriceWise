...
public class HashbrownsFragment extends Fragment {

    private HashbrownsViewModel mViewModel;
    private UserViewModel userViewModel;

    public static HashbrownsFragment newInstance() {
        return new HashbrownsFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_hashbrowns, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(HashbrownsViewModel.class);
