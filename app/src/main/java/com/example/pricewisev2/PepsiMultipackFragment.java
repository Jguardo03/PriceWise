...
public class PepsiMultipackFragment extends Fragment {

    private PepsiMultipackViewModel mViewModel;
    private UserViewModel userViewModel;

    public static PepsiMultipackFragment newInstance() {
        return new PepsiMultipackFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_pepsi_multipack, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(PepsiMultipackViewModel.class);
