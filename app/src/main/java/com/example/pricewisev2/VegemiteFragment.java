...
public class VegemiteFragment extends Fragment {

    private VegemiteViewModel mViewModel;
    private UserViewModel userViewModel;

    public static VegemiteFragment newInstance() {
        return new VegemiteFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_vegemite, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(VegemiteViewModel.class);
