...
public class EnglishMuffinsFragment extends Fragment {

    private EnglishMuffinsViewModel mViewModel;
    private UserViewModel userViewModel;

    public static EnglishMuffinsFragment newInstance() {
        return new EnglishMuffinsFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_english_muffins, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(EnglishMuffinsViewModel.class);
