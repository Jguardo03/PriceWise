...
public class BlueBerriesFragment extends Fragment {

    private BlueBerriesViewModel mViewModel;
    private UserViewModel userViewModel;

    public static BlueBerriesFragment newInstance() {
        return new BlueBerriesFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_blue_berries, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(BlueBerriesViewModel.class);
