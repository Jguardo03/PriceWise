...
public class TacoSheelsFragment extends Fragment {

    private TacoSheelsViewModel mViewModel;
    private UserViewModel userViewModel;

    public static TacoSheelsFragment newInstance() {
        return new TacoSheelsFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_taco_sheels, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(TacoSheelsViewModel.class);
