...
public class JazminRiceFragment extends Fragment {

    private JazminRiceViewModel mViewModel;
    private UserViewModel userViewModel;

    public static JazminRiceFragment newInstance() {
        return new JazminRiceFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_jazmin_rice, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(JazminRiceViewModel.class);
