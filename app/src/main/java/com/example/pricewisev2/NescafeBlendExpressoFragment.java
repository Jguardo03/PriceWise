...
public class NescafeBlendExpressoFragment extends Fragment {

    private NescafeBlendExpressoViewModel mViewModel;
    private UserViewModel userViewModel;

    public static NescafeBlendExpressoFragment newInstance() {
        return new NescafeBlendExpressoFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_nescafe_blend_expresso, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(NescafeBlendExpressoViewModel.class);
