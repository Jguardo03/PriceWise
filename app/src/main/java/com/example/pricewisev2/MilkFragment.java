...
import com.example.pricewisev2.Recycleview.ProductCardAdapter;
import com.example.pricewisev2.Recycleview.ProductCardModel;
...
import com.example.pricewisev2.databinding.FragmentMilkBinding;
...
public class MilkFragment extends Fragment {
    ...
    private MilkViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(MilkViewModel.class);
