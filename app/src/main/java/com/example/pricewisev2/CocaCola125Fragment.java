...
public class CocaCola125Fragment extends Fragment {

    private CocaCola125ViewModel mViewModel;
    private UserViewModel userViewModel;

    public static CocaCola125Fragment newInstance() {
        return new CocaCola125Fragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_coca_cola125, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(CocaCola125ViewModel.class);
