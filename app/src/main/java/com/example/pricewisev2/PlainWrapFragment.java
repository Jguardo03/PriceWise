...
public class PlainWrapFragment extends Fragment {

    private PlainWrapViewModel mViewModel;
    private UserViewModel userViewModel;

    public static PlainWrapFragment newInstance() {
        return new PlainWrapFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_plain_wrap, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(PlainWrapViewModel.class);
