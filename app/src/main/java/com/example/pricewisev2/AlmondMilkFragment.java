...
public class AlmondMilkFragment extends Fragment {

    private AlmondMilkViewModel mViewModel;
    private UserViewModel userViewModel;

    public static AlmondMilkFragment newInstance() {
        return new AlmondMilkFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_almond_milk, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AlmondMilkViewModel.class);
