...
public class SausageRollsFragment extends Fragment {

    private SausageRollsViewModel mViewModel;
    private UserViewModel userViewModel;

    public static SausageRollsFragment newInstance() {
        return new SausageRollsFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_sausage_rolls, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(SausageRollsViewModel.class);
