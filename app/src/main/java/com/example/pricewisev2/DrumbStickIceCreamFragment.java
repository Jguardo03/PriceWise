...
public class DrumbStickIceCreamFragment extends Fragment {

    private DrumbStickIceCreamViewModel mViewModel;
    private UserViewModel userViewModel;

    public static DrumbStickIceCreamFragment newInstance() {
        return new DrumbStickIceCreamFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_drumb_stick_ice_cream, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(DrumbStickIceCreamViewModel.class);
