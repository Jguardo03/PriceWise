...
public class WhiteBreadFragment extends Fragment {

    private WhiteBreadViewModel mViewModel;
    private UserViewModel userViewModel;

    public static WhiteBreadFragment newInstance() {
        return new WhiteBreadFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_white_bread, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(WhiteBreadViewModel.class);
