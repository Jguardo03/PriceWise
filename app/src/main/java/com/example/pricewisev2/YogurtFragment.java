...
public class YogurtFragment extends Fragment {
    ...
    private YogurtViewModel mViewModel;
    private UserViewModel userViewModel;

    public static YogurtFragment newInstance() {
        return new YogurtFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(YogurtViewModel.class);
