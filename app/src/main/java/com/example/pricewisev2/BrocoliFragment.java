...
public class BrocoliFragment extends Fragment {

    private BrocoliViewModel mViewModel;
    private UserViewModel userViewModel;

    public static BrocoliFragment newInstance() {
        return new BrocoliFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_brocoli, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(BrocoliViewModel.class);
