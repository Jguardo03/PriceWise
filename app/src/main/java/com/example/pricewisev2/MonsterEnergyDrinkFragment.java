...
public class MonsterEnergyDrinkFragment extends Fragment {

    private MonsterEnergyDrinkViewModel mViewModel;
    private UserViewModel userViewModel;

    public static MonsterEnergyDrinkFragment newInstance() {
        return new MonsterEnergyDrinkFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_monster_energy_drink, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(MonsterEnergyDrinkViewModel.class);
