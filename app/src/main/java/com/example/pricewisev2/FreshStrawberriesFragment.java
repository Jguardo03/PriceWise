...
public class FreshStrawberriesFragment extends Fragment {

    private FreshStrawberriesViewModel mViewModel;
    private UserViewModel userViewModel;

    public static FreshStrawberriesFragment newInstance() {
        return new FreshStrawberriesFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_fresh_strawberries, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(FreshStrawberriesViewModel.class);
