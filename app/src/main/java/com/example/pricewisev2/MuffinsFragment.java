...
public class MuffinsFragment extends Fragment {
    ...
    private MuffinsViewModel mViewModel;
    private UserViewModel userViewModel;

    public static MuffinsFragment newInstance() {
        return new MuffinsFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_muffins, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(MuffinsViewModel.class);
