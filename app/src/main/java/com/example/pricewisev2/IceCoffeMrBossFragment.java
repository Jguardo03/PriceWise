...
public class IceCoffeMrBossFragment extends Fragment {

    private IceCoffeMrBossViewModel mViewModel;
    private UserViewModel userViewModel;

    public static IceCoffeMrBossFragment newInstance() {
        return new IceCoffeMrBossFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_ice_coffe_mr_boss, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(IceCoffeMrBossViewModel.class);
