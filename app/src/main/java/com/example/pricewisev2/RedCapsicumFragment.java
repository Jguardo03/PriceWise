...
public class RedCapsicumFragment extends Fragment {

    private RedCapsicumViewModel mViewModel;
    private UserViewModel userViewModel;

    public static RedCapsicumFragment newInstance() {
        return new RedCapsicumFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_red_capsicum, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(RedCapsicumViewModel.class);
