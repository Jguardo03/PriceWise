...
public class FrozenPEasFragment extends Fragment {

    private FrozenPEasViewModel mViewModel;
    private UserViewModel userViewModel;

    public static FrozenPEasFragment newInstance() {
        return new FrozenPEasFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_frozen_p_eas, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(FrozenPEasViewModel.class);
