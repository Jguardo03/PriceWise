...
public class SpringWaterCanTunaFragment extends Fragment {

    private SpringWaterCanTunaViewModel mViewModel;
    private UserViewModel userViewModel;

    public static SpringWaterCanTunaFragment newInstance() {
        return new SpringWaterCanTunaFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_spring_water_can_tuna, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(SpringWaterCanTunaViewModel.class);
