...
public class AustralianHoneyFragment extends Fragment {

    private AustralianHoneyViewModel mViewModel;
    private UserViewModel userViewModel;

    public static AustralianHoneyFragment newInstance() {
        return new AustralianHoneyFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_australian_honey, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(AustralianHoneyViewModel.class);
